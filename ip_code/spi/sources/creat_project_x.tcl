...
ipgui::move_param -component [ipx::current_core] -order 1 [ipgui::get_guiparamspec -name "spi_rate" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
ipgui::move_param -component [ipx::current_core] -order 2 [ipgui::get_guiparamspec -name "cs_buff_time" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
ipgui::move_param -component [ipx::current_core] -order 3 [ipgui::get_guiparamspec -name "sck_buff_time" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
ipgui::move_param -component [ipx::current_core] -order 4 [ipgui::get_guiparamspec -name "mode" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
...
set_property widget {textEdit} [ipgui::get_guiparamspec -name "spi_rate" -component [ipx::current_core] ]
set_property tooltip {unit:Hz} [ipgui::get_guiparamspec -name "spi_rate" -component [ipx::current_core] ]
set_property widget {textEdit} [ipgui::get_guiparamspec -name "cs_buff_time" -component [ipx::current_core] ]
set_property tooltip {Buffer time for cs to maintain a stable high level before the falling edge (unit: one data length).} [ipgui::get_guiparamspec -name "cs_buff_time" -component [ipx::current_core] ]
set_property widget {textEdit} [ipgui::get_guiparamspec -name "sck_buff_time" -component [ipx::current_core] ]
set_property tooltip {Buffer time between cs and sck (unit: one data length).} [ipgui::get_guiparamspec -name "sck_buff_time" -component [ipx::current_core] ]
set_property widget {textEdit} [ipgui::get_guiparamspec -name "mode" -component [ipx::current_core] ]
set_property tooltip {Set SPI to work in 3-wire or 4-wire mode.} [ipgui::get_guiparamspec -name "mode" -component [ipx::current_core] ]
set_property widget {comboBox} [ipgui::get_guiparamspec -name "mode" -component [ipx::current_core] ]
set_property value_validation_list {"3 Wire" "4 Wire"} [ipx::get_user_parameters mode -of_objects [ipx::current_core]]

set_property enablement_dependency {spirit:decode(id('MODELPARAM_VALUE.mode')) == "3 Wire"} \
  [ipx::get_ports sdio -of_objects [ipx::current_core]]
set_property enablement_dependency {spirit:decode(id('MODELPARAM_VALUE.mode')) == "4 Wire"} \
  [ipx::get_ports miso -of_objects [ipx::current_core]] 
set_property enablement_dependency {spirit:decode(id('MODELPARAM_VALUE.mode')) == "4 Wire"} \
  [ipx::get_ports mosi -of_objects [ipx::current_core]] 
...
cd ../../ip_code/$project_name/project
